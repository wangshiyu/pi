...
#     list_ = userTcpAddressService.getListByEntity(userTcpAddressEntity)
#     resultList = list()
#     if len(list_) != 0:
...
#             resultList.append(userTcpAddressDTO.toDict())
#     return PiHttpResponse.toJson(AjaxResult.buildSuccessAjaxResult(resultList))  # ajax请求
