...
import pi_client.modeling_3d.color
from pi_client.modeling_3d.scene import Scene
from pi_client.modeling_3d.primitive import init_primitives, G_OBJ_PLANE
from pi_client.modeling_3d.node import Sphere, Cube, SnowFigure
from pi_client.modeling_3d.interaction import Interaction
...
class Viewer(object):
    ...
    def create_sample_scene(self):
        ...
        cube_node1 = Cube()
        cube_node1.translate(2, 2, 0)
        cube_node1.color_index = 1
        self.scene.add_node(cube_node1)
